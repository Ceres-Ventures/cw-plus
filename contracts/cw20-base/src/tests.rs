...
mod tests {
    ...
    use crate::contract::{execute, query, query_balance, query_minter, query_token_info};
    ...
    */
    ...
    mod instantiate {
        use crate::contract::query_minter;
        ...
        mod marketing {
            use crate::contract::{query_download_logo, query_marketing_info};
    ...
    */
    ...
    mod marketing {
        use crate::contract::{execute, query_download_logo, query_marketing_info};
